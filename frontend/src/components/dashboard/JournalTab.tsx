    ...
    <div className="max-w-4xl mx-auto animate-fade-in">
      ...
      {entries.length === 0 ? (
        ...
        <div className="grid gap-6">
          {entries.map((entry) => (
            <div key={entry.id} className="card p-6 hover:shadow-medium transition-all">
              ...
              {entry.summary && (
                <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 p-4 rounded-lg border-l-4 border-purple-400">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-sm font-medium text-purple-800 dark:text-purple-200 mb-1">AI Insight</p>
                      <p className="text-sm text-purple-700 dark:text-purple-300">{entry.summary}</p>
                    </div>
                  </div>
                </div>
              )}
